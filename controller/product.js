...
const getProductByDepartmentId=async(req,res)=>{
...
const getProductDetialsByProductId=async(req,res)=>{
...
const getProductLocationByProductId=async(req,res)=>{
...
const createPostReviews=async(req,res)=>{
